...
public class ExcelTest {
    ...
    public static void main(String[] args) throws InvalidFormatException {
        try {
            FileInputStream file = new FileInputStream("src/main/resources/王菲1.xlsx");
            XSSFWorkbook workbook = (XSSFWorkbook) WorkbookFactory.create(file);
            Sheet sheet = workbook.getSheetAt(0);
            int count = 0;
            FileOutputStream fileOutputStream = new FileOutputStream("src/main/resources/tmp.json");
